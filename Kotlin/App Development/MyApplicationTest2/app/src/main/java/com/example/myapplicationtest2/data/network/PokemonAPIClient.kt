package com.example.myapplicationtest2.data.network
...
class PokemonAPIClient {
    class PokemonApiClient {
        ...
        suspend fun getPokemonList(limit:Int): com.example.myapplicationtest2.data.network.model.PokedexObject?{
            api = NetworkModuleDI()
            return try{
