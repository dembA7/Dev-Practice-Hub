/*
 * Un objeto se puede comportar de diferentes formas según el contexto.
 * El principio de sustitución es utilizar un objeto de la subclase 
 * siempre y cuando el programa espere un objeto de la superclase. 
*/
